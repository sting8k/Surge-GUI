...
- New spec: turn a user-provided project spec into harness-ready docs.
  - Typical artifact: product docs, candidate epics, decisions.
- Spec slice: implement selected behavior from an accepted spec.
  - Typical artifact: story packet.
- Change request: change, fix, or refine accepted behavior.
  - Typical artifact: story packet or direct patch.
- New initiative: add a larger product area that needs multiple stories.
  - Typical artifact: initiative notes plus story packets.
- Maintenance request: change technical, operational, or dependency behavior.
  - Typical artifact: story packet, validation report, or decision.
- Harness improvement: improve how humans and agents collaborate.
  - Typical artifact: direct docs update or `docs/HARNESS_BACKLOG.md`.
...
- Cross-platform: desktop, mobile, browser, native shell, or deep links.
